...
const menuItems = [
  { icon: FileText, label: "Medical Records", desc: "View your health history" },
  { icon: Pill, label: "Prescriptions", desc: "Digital prescriptions & reminders" },
  { icon: Bell, label: "Notifications", desc: "Manage alerts & reminders" },
  { icon: Globe, label: "Language", desc: "English • हिन्दी • தமிழ் • తెలుగు" },
  { icon: Accessibility, label: "Accessibility", desc: "Large text, voice input" },
  { icon: Shield, label: "Privacy & Security", desc: "Data sharing & consent" },
];
